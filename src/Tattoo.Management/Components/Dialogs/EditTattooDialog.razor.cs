...
{
    public partial class EditTattooDialog
    {
        //Declaration
        ...
        [Parameter] public TattooDto _tattooBase { get; set; }
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _creationForm.Id = _tattooBase.Id;
            _creationForm.TattooName = _tattooBase.TattooName;
            _creationForm.TattooStyleId = _tattooBase.TattooStyleId;
            _creationForm.ImagePath = _tattooBase.ImagePath;
            _creationForm.MiniatureImagePath = _tattooBase.MiniatureImagePath;
        }
        ...
        {
            var response = await _tattooService.UpdateTattooAsync(_creationForm);
