...
namespace App.Infrastructure.Migrations
{
    ...
    [Migration("20241014142412_transactiongroupProduct")]
    partial class transactiongroupProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<int>("TransactionGroup")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Domain.Entities.RawMaterial", b =>
                {
                    b.HasBaseType("App.Domain.Entities.Product");

                    b.HasDiscriminator().HasValue("RawMaterial");
                });
            ...
            modelBuilder.Entity("App.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("App.Domain.Entities.RawMaterial", "RawMaterial")
                        .WithMany()
